...
const BLOG = {
  ...
  FONT_AWESOME_PATH:
    'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css', // 图标库CDN ，国外推荐CloudFlare，国内推荐 BootCDN https://cdn.bootcdn.net/ajax/libs/font-awesome/5.15.4/css/all.min.css
  ...
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/itauge',
  CONTACT_TELEGRAM: '',
